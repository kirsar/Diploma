...
namespace Examinator
{
	...
	public class ExamTree
	{
		...
		public void SetItemChild ( Mark cMark )
		{
			...
			switch ( cMark )
			{
				case ( Mark.eExcellent ):
					...
					break;
				case ( Mark.eGood ):
					m_cTreeItems[iCurrIndex].NextChild = m_cTreeItems[iCurrIndex].GoodChild;
					break;
				case (Mark.eSatisfactory ):
					m_cTreeItems[iCurrIndex].NextChild = m_cTreeItems[iCurrIndex].SatChild;
					break;
				case ( Mark.eUnsatisfactory ):
					m_cTreeItems[iCurrIndex].NextChild = m_cTreeItems[iCurrIndex].UnsatChild;
					break;
			}
		}
		...
		private int GetIndexByNumber ( int iNumber )
		{
